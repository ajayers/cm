...
defmodule CouponMarketWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: CouponMarketWeb.Coherence.EmailView, layout: {CouponMarketWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
